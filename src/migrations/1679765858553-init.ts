...
export class init1679765858553 implements MigrationInterface {
    name = 'init1679765858553'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ingredients" ("id" varchar2(36), "name" varchar2(200) NOT NULL, "set" number NOT NULL, "unit" varchar2(255), "amount" float, "external_id" number, "nutrients_source_id" number, CONSTRAINT "PK_9240185c8a5507251c9f15e0649" PRIMARY KEY ("id"))`);
